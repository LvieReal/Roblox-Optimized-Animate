...
Create a Script inside the module, name it ActivateScript, set it's RunContext to Client and paste this code in:
`require(script:GetAttribute("Path")).AddCharacter(script, script.Parent)`
To activate the module during run time, create a Script in ServerScriptService and paste:
